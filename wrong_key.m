function time = wrong_key(window,color,sounds,where,stim,time,doNotClear)
%function time = wrong_key(window,color,sounds,where,stim, time,doNotClear)
%
...
string = 'You did not click on either the rain or the sun'; 
...
string = 'Please click on either the rain or the sun';
[normBoundsRect, offsetBoundsRect]= Screen('TextBounds', window, string);
