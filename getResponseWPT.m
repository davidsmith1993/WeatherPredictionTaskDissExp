function [resp,correct,rt,time,data] = getResponseWPT(window,sounds,feedback,color,where,stim,time,data,presExample,trial,trainTest,trialWithinBlock,blockNum)
